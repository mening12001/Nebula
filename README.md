...
As it can be observed in Main.java class from Nebula-Master, it is executed as an example an ActualComputation, but also a lambda(Remote Lambda).
I consider that the code is self-explanatory.

Don't retain yourself from participating, to develop further this intriguing project. Thank you!
